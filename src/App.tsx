          ...
          <ModuleStateProvider>
            <Router>
              <Routes>
                ...
                <Route
                  path="/app"
                  element={<Navigate to="/pandaura-as" replace />}
                />
                <Route
                  path="/pandaura-as"
                  element={
                ...
                <Route
                  path="/workspace/:projectId/pandaura-as"
                  element={
                    <ProtectedRoute>
                      <ProjectSyncProvider>
                        <SharedLayout>
                ...
                />
                <Route
                  path="/workspace/:projectId/logic-studio"
                  element={
                    <ProtectedRoute>
                      <ProjectSyncProvider>
                        <SharedLayout>
                ...
                />
                <Route
                  path="/workspace/:projectId/autodocs"
                  element={
                    <ProtectedRoute>
                      <ProjectSyncProvider>
                        <SharedLayout>
                ...
                />
                <Route
                  path="/workspace/:projectId/tag-database"
                  element={
                    <ProtectedRoute>
                      <ProjectSyncProvider>
                        <SharedLayout>
                ...
                />
                <Route
                  path="/workspace/:projectId/case-studies"
                  element={
                    <ProtectedRoute>
                      <ProjectSyncProvider>
                        <SharedLayout>
                ...
                <Route
                  ...
                  element={
                    <SessionLayout>
                      <ErrorBoundary>
                        <TagDatabaseManager sessionMode={true} />
                      </ErrorBoundary>
                    </SessionLayout>
                  }
                />
                    ...
                    <SessionLayout>
                      <div className="p-8 text-center">
                        <h1 className="text-2xl font-bold text-primary">
                          SignalFlow (Coming Soon)
                        </h1>
                        <p className="text-muted mt-2">
                          Signal path visualization and tracing
                        </p>
                      </div>
                    </SessionLayout>
                  }
